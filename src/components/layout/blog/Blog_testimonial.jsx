  ...
  return (
    ...
    <section className='py-2 lg:pt-6 px-3 lg:px-0'>
        <div className="max-w-[850px] m-auto">
            <div className={"flex gap-x-5 border-t border-b py-7"}>
                ...
                <div className="">
                    ...
                    <Para15 text={"Etiam vitae leo et diam pellentesque porta. Sed eleifend ultricies risus, vel rutrum erat commodo ut. Praesent finibus congue euismod. Nullam scelerisque massa vel augue placerat, a tempor sem egestas. Curabitur placerat finibus lacus."} className={"text-textClr1! max-w-[670px] line-clamp-3 lg:line-clamp-none text-justify"}/>
                </div>
            </div>
