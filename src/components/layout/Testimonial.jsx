      ...
      <section className="pt-10 lg:pt-[120px] pb-10 lg:pb-[100px] px-3 lg:px-0 bg-[url(/src/assets/testimonialBg.png)] bg-no-repeat bg-cover bg-center">
        <Container>
          <div className="text-center">
            <h4 className="pb-3 lg:pb-5 text-2xl lg:text-3xl text-textClr1 font-semibold">
              Testimonials
            </h4>
            ...
            <div className="pt-8 lg:pt-12.5 pb-6 lg:pb-9">
              <p className="pb-2 lg:pb-4 text-sm lg:text-[15px] text-textClr1 font-medium">Ali Tufan</p>
